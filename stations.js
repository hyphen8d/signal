...
export const STATIONS = [
  ...
  { id: 'slow-orbit', band: 'zm', freq: 1092.0, callsign: 'SLOW ORBIT',
    ...
    tracks: [
      ...
      realTrack('h9gVHqe9dj8', 'Love Double', 'Jens Buchert'),
      realTrack('0nUdJeDoDY0', 'Lightful', 'Lemongrass'),
      realTrack('8fpFTNmHE4c', 'Where Is Mr. Spock?', 'Lemongrass'),
      realTrack('tGBqcd2-_xM', 'Mysterious You', 'Celeste Lear'),
      realTrack('O5xuh4KxyKE', 'Traveler', 'Celeste Lear'),
      realTrack('z8ajEiw6iYk', 'Planted', 'Sounds from the Ground'),
